...
function onSubmit() {
    ...
    try {
        ...
        this.oListItem = oList.getItemById(evidenceBiteID);
        ...
        if (isLocationSpecific) {
            ...
            taxFieldRegion.validateSetValue(oListItem, null);
            taxFieldArea.validateSetValue(oListItem, null);
            taxFieldLocation.validateSetValue(oListItem, null);
        }
        ...
        if (isSectorSpecific) {
            ...
            taxFieldSector.validateSetValue(oListItem, null);
            taxFieldSubSector.validateSetValue(oListItem, null);
        }
        ...
        //Evidence Bstart awardsite Heading
        ...
        if ($("#txtBenefits").val())
            ...
            oListItem.set_item('Evidence_x0020_Bite_x0020_Benefi', null);
        oListItem.update();
...
function onQuerySucceeded() {
    ...
    successMessage = "Successfully updated the 'Generic Evidence Bite'" + "<br />" + "Do you want to view the updated information ?"
    confirm(successMessage);
}

function onQueryFailed(sender, args) {
    LogError(args);
    $('input[type=button][value=Save]').attr('disabled', '');
