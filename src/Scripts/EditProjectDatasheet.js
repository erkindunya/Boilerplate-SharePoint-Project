    ...
    try {
        ...
        if (cntProcurement > 0) {
            ...
            if (procurementSubTypeValue) {
                if (procurementSubTypeValue.toLowerCase() == 'other') {
                    $('.OtherTxt').show();
                }
...
function onLoadListItemsSucceeded() {
    ...
    $('#ddlStageOfProject').trigger('change');
    ...
    if (listItem.get_item("External_x0020_JV") || isExternal == 1) {
    ...
    if (completionValue) {
        ...
        if (awardValue - completionValue < 0) {
            ...
            if (listItem.get_item("Agreed_x0020_cost_x0020_variance"))
                ...
                $("input[name=rbAgreedCostVariance][value='No']").attr('checked', 'checked');
    ...
    if (listItem.get_item('Reason_x0020_for_x0020_extension') != null && listItem.get_item('Reason_x0020_for_x0020_extension') != '') {
        ...
        if (listItem.get_item("Extension_x0020_of_x0020_time_x0"))
            ...
            $("input[name=rbAgreedExtension][value='No']").attr('checked', 'checked');
        //Reason for agreed change
