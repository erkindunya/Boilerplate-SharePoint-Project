...
function insertProjectDatasheet(isDraft){
				...
				//CCS Is Non-dicslosure aggrement
				...
				// Is Best Bid Field
				// if ($( "#chkIsBestBid" ).prop( "checked", true )) {
				// 	oListItem.set_item('isBestBid', "1");
				// } else if ($( "#chkIsBestBid" ).prop( "checked", false )) {
				// 	oListItem.set_item('isBestBid', "0");
				// } else {
				// 	oListItem.set_item('isBestBid', "0");
				// }

				if ($("#chkIsBestBid").is(':checked'))
					oListItem.set_item('isBestBid', '1');
				else
					oListItem.set_item('isBestBid', '0');
				...
				// Champion
				// var champ = $("#txtAuthor").attr("value");
				// if (champ)
			 ...
			 if ($("#ddlCEEQUALRating option:selected").val() != 'default') {
				...
				} else if ($("input:radio[name='rbClientReference1']:checked").val() == "No"){
