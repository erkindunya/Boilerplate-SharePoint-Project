...
function loadMasterData() {
    ...
    projectDatasheetID = getParameterByName('PDID');
...
function onLoadListItemsSucceeded() {
    ...
    $("#txtAuthor").val(listItem.get_item("Author").get_lookupValue());
	...
	{
		var BidLeadVals = listItem.get_item('Bid_x0020_Lead');		
		$("#ppBidLead").val(BidLeadVals.get_lookupValue());
		bidLeadID=BidLeadVals.get_lookupId();
	}
	...
	{
		var QSCommercia = listItem.get_item('QS_x0020__x002F__x0020_Commercia');
		
		$("#ppCommercialManager").val(QSCommercia.get_lookupValue() );
		commercialManagerID=QSCommercia.get_lookupId();
	}
    // if (listItem.get_item('QS_x0020__x002F__x0020_Commercia') != null)
	...
	{
		var QSCommercia = listItem.get_item('Project_x0020__x002F__x0020_Cont');		
		$("#ppContractsManager").val(QSCommercia.get_lookupValue() );
		contractsManagerID=QSCommercia.get_lookupId();
	...
	{
		var DesignManager = listItem.get_item('Design_x0020_Manager');
		
		$("#ppDesignManager").val(DesignManager.get_lookupValue() );
		designManagerID=DesignManager.get_lookupId();
	}
    // if (listItem.get_item('Design_x0020_Manager') != null)
