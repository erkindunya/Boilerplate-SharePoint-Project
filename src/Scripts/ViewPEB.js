...
function loadMasterData() {
    ...
    var projectEBID = getParameterByName('ID');
...
function onLoadListItemsSucceeded() {
    ...
    $(".evidenceBiteInfo :input").attr("disabled", true);
    $(".awardsPEB :input").attr("disabled", true);
    $(".formButtons :input").attr("disabled", false);


    //ProjectDatasheetID=listItem.get_item('ProjectDatasheetID').get_lookupValue();
    ...
    if (listItem.get_item("Kier_x0020_Delivery_x0020_Region") != null && listItem.get_item("Kier_x0020_Delivery_x0020_Region") != '')
...
function BindProjectDocuments(projectDatasheetID, TestimonialType) {
